...
#>>>Import data<<<
# Normal conditions 
day = read.csv("/Users/grisv/GitHub/Manifest/data/sample_normal_day.csv",header = FALSE)
# Faulty day data
...
day1 = read.csv("/Users/grisv/GitHub/Manifest/data/sample_normal_day.csv",header = FALSE)
# plot 
