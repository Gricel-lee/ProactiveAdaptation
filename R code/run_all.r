...
# Read violation map      (added if generated in separate file)
vmap <- read.csv("violationMap.csv", header = TRUE)


# ---- Section: Data Preparation ---- #
day <- read.csv("/Users/grisv/GitHub/Manifest/R code/sample_day_filtered.csv") # used to get column names # nolint
